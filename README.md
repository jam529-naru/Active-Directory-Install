...
<b>*Note: Creating the Client VM is not a mandatory step. This is only for teaching purposes to mock a random computer at a school, business, etc that is connected to a Domain Controller*</b>
